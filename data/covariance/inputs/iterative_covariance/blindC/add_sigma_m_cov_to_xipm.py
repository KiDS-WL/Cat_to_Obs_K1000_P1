...
filename="../../../../kids/fits_iterative_covariance/xipm_KIDS1000_Blind"+blind+"_no_m_bias_V1.0.0A_ugriZYJHKs_photoz_SG_mask_LF_svn_309c_2Dbins_v2_goldclasses_Flag_SOM_Fid.fits"
...
# 
				...
				filename='../../input_for_xipm_sigma_m_covariance_iterative/chain/output_test_C/shear_xi_plus_binned/bin_'+str(z2+1)+'_'+str(z1+1)+'.txt'
				file  = open(filename)
				xip_z1_z2 = np.loadtxt(file)
# 
				filename='../../input_for_xipm_sigma_m_covariance_iterative/chain/output_test_C/shear_xi_plus_binned/bin_'+str(z4+1)+'_'+str(z3+1)+'.txt'
				file  = open(filename)
				xip_z3_z4 = np.loadtxt(file)
# 
				filename='../../input_for_xipm_sigma_m_covariance_iterative/chain/output_test_C/shear_xi_minus_binned/bin_'+str(z2+1)+'_'+str(z1+1)+'.txt'
				file  = open(filename)
				xim_z1_z2 = np.loadtxt(file)
# 
				filename='../../input_for_xipm_sigma_m_covariance_iterative/chain/output_test_C/shear_xi_minus_binned/bin_'+str(z4+1)+'_'+str(z3+1)+'.txt'
				file  = open(filename)
