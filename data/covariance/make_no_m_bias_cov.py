...
blind = 'C'
filename='outputs/Covariance_blind'+blind+'_nMaximum_20_0.50_300.00_nBins5.ascii'
file=open(filename)
cov_all=np.loadtxt(file,comments='#')

filename='outputs/Covariance_blind'+blind+'_nMaximum_20_0.50_300.00_nBins5_sigma_m_from_m_cov_0.0000.ascii'
file=open(filename)
cov_sigma_m=np.loadtxt(file,comments='#')

cov_no_m_bias = cov_all - cov_sigma_m

filename='outputs/Covariance_no_m_bias_blind'+blind+'_nMaximum_20_0.50_300.00_nBins5.ascii'
